 ...
 *
 * Enterprise-grade login form with:
...
import { AlertTriangle, ArrowRight, Lock, Mail, Shield, User, Zap } from "lucide-react";
    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 flex flex-col items-center animate-fade-in">
          ...
          >
            Industrial Data Quality & Observability
          </p>
        </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
            ...
            >
              ...
              <p className="text-xs mb-4" style={{ color: "var(--color-sentinel-text-secondary)" }}>
                Enter your Gmail account details and choose your platform role to sign in via Google:
              </p>
              ...
              <form onSubmit={handleGoogleSignIn} className="space-y-4">
                ...
                <div className="pt-2 flex gap-2">
                  ...
                  >
                    {isGoogleLoading ? <div className="spinner" /> : <>Continue with Google <ArrowRight size={14} /></>}
                  </button>
                </div>
              </form>
            </div>
